module.exports.signUpErrors = (err) => {
  ...
  if (err.message.includes("firstName"))
    errors.firstName = "Your firstname must be at least 3 characters.";

  if (err.message.includes("lastName"))
    errors.lastName = "Your lastname must be at least 3 characters.";
  ...
  if (err.message.includes("birthday"))
    errors.password = "You need to have 18 years old for subscribe.";
  ...
  if (err.message.includes("firstName") && err.message.includes("birthday"))
    errors.firstName +
      (errors.birthday =
